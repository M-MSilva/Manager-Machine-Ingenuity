...
To compile the code it is necessary to have any compiler that runs programs in c++ (compilers list - https://en.wikipedia.org/wiki/List_of_compilers), besides this list there are online compilers that easily implement the code such as https://www.onlinegdb.com/ and https://replit.com.
